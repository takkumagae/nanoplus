/* Auto-generated by genmsg_cpp for file /home/root/ros/quadrotor_msgs/msg/SO3Command.msg */
...
struct SO3Command_ {
  ...
  ROS_DEPRECATED uint32_t get_kR_size() const { return (uint32_t)kR.size(); }
  ROS_DEPRECATED uint32_t get_kOm_size() const { return (uint32_t)kOm.size(); }
private:
  static const char* __s_getDataType_() { return "quadrotor_msgs/SO3Command"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "a466650b2633e768513aa3bf62383c86"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, kR);
    ros::serialization::serialize(stream, kOm);
    ros::serialization::serialize(stream, aux);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, kR);
    ros::serialization::deserialize(stream, kOm);
    ros::serialization::deserialize(stream, aux);
    return stream.getData();
  }
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(kR);
    size += ros::serialization::serializationLength(kOm);
    size += ros::serialization::serializationLength(aux);
    return size;
  }
