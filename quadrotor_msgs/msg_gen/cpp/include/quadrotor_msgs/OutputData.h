/* Auto-generated by genmsg_cpp for file /home/root/ros/quadrotor_msgs/msg/OutputData.msg */
...
struct OutputData_ {
  ...
  ROS_DEPRECATED uint32_t get_radio_channel_size() const { return (uint32_t)radio_channel.size(); }
private:
  static const char* __s_getDataType_() { return "quadrotor_msgs/OutputData"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "5759ee97fd5c090dcdccf7fc3e50d024"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, pressure_dheight);
    ros::serialization::serialize(stream, pressure_height);
    ros::serialization::serialize(stream, magnetic_field);
    ros::serialization::serialize(stream, radio_channel);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, pressure_dheight);
    ros::serialization::deserialize(stream, pressure_height);
    ros::serialization::deserialize(stream, magnetic_field);
    ros::serialization::deserialize(stream, radio_channel);
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(pressure_dheight);
    size += ros::serialization::serializationLength(pressure_height);
    size += ros::serialization::serializationLength(magnetic_field);
    size += ros::serialization::serializationLength(radio_channel);
