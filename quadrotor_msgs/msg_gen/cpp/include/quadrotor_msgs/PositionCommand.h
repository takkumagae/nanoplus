/* Auto-generated by genmsg_cpp for file /home/root/ros/quadrotor_msgs/msg/PositionCommand.msg */
...
struct PositionCommand_ {
  ...
  ROS_DEPRECATED uint32_t get_kx_size() const { return (uint32_t)kx.size(); }
  ROS_DEPRECATED uint32_t get_kv_size() const { return (uint32_t)kv.size(); }
private:
  static const char* __s_getDataType_() { return "quadrotor_msgs/PositionCommand"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "835935bcd6f18632d9e26a3093237902"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, yaw_dot);
    ros::serialization::serialize(stream, kx);
    ros::serialization::serialize(stream, kv);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, yaw_dot);
    ros::serialization::deserialize(stream, kx);
    ros::serialization::deserialize(stream, kv);
    return stream.getData();
  }
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(yaw_dot);
    size += ros::serialization::serializationLength(kx);
    size += ros::serialization::serializationLength(kv);
    return size;
  }
