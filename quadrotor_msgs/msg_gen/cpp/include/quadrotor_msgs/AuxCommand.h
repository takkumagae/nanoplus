/* Auto-generated by genmsg_cpp for file /home/root/ros/quadrotor_msgs/msg/AuxCommand.msg */
...
private:
  static const char* __s_getDataType_() { return "quadrotor_msgs/AuxCommand"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "94f75840e4b1e03675da764692f2c839"; }
public:
...
private:
  static const char* __s_getMessageDefinition_() { return "float64 current_yaw\n\
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, current_yaw);
    ros::serialization::serialize(stream, kf_correction);
    ros::serialization::serialize(stream, angle_corrections);
    ros::serialization::serialize(stream, enable_motors);
    ros::serialization::serialize(stream, use_external_yaw);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, current_yaw);
    ros::serialization::deserialize(stream, kf_correction);
    ros::serialization::deserialize(stream, angle_corrections);
    ros::serialization::deserialize(stream, enable_motors);
    ros::serialization::deserialize(stream, use_external_yaw);
    return stream.getData();
  }
  ...
  {
    uint32_t size = 0;
    size += ros::serialization::serializationLength(current_yaw);
    size += ros::serialization::serializationLength(kf_correction);
    size += ros::serialization::serializationLength(angle_corrections);
    size += ros::serialization::serializationLength(enable_motors);
    size += ros::serialization::serializationLength(use_external_yaw);
    return size;
  }
