"""autogenerated by genmsg_py from SO3Command.msg. Do not edit."""
...
class SO3Command(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','float64[3]','float64[3]','quadrotor_msgs/AuxCommand']
