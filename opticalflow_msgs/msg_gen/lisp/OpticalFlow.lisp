...
(cl:defmethod cl:initialize-instance :after ((m <OpticalFlow>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OpticalFlow)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opticalflow_msgs-msg:<OpticalFlow> is deprecated: use opticalflow_msgs-msg:OpticalFlow instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <OpticalFlow>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:header-val is deprecated.  Use opticalflow_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'ground_distance-val :lambda-list '(m))
(cl:defmethod ground_distance-val ((m <OpticalFlow>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:ground_distance-val is deprecated.  Use opticalflow_msgs-msg:ground_distance instead.")
  (ground_distance m))

(cl:ensure-generic-function 'flow_x-val :lambda-list '(m))
(cl:defmethod flow_x-val ((m <OpticalFlow>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:flow_x-val is deprecated.  Use opticalflow_msgs-msg:flow_x instead.")
  (flow_x m))

(cl:ensure-generic-function 'flow_y-val :lambda-list '(m))
(cl:defmethod flow_y-val ((m <OpticalFlow>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:flow_y-val is deprecated.  Use opticalflow_msgs-msg:flow_y instead.")
  (flow_y m))

(cl:ensure-generic-function 'velocity_x-val :lambda-list '(m))
(cl:defmethod velocity_x-val ((m <OpticalFlow>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:velocity_x-val is deprecated.  Use opticalflow_msgs-msg:velocity_x instead.")
  (velocity_x m))

(cl:ensure-generic-function 'velocity_y-val :lambda-list '(m))
(cl:defmethod velocity_y-val ((m <OpticalFlow>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:velocity_y-val is deprecated.  Use opticalflow_msgs-msg:velocity_y instead.")
  (velocity_y m))

(cl:ensure-generic-function 'quality-val :lambda-list '(m))
(cl:defmethod quality-val ((m <OpticalFlow>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:quality-val is deprecated.  Use opticalflow_msgs-msg:quality instead.")
  (quality m))
