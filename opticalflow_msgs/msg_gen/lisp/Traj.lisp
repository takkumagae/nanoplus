...
(cl:defmethod cl:initialize-instance :after ((m <Traj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Traj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opticalflow_msgs-msg:<Traj> is deprecated: use opticalflow_msgs-msg:Traj instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Traj>))
...
(cl:defmethod acc_x-val ((m <Traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:acc_x-val is deprecated.  Use opticalflow_msgs-msg:acc_x instead.")
  (acc_x m))

(cl:ensure-generic-function 'acc_y-val :lambda-list '(m))
(cl:defmethod acc_y-val ((m <Traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:acc_y-val is deprecated.  Use opticalflow_msgs-msg:acc_y instead.")
  (acc_y m))

(cl:ensure-generic-function 'acc_z-val :lambda-list '(m))
(cl:defmethod acc_z-val ((m <Traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:acc_z-val is deprecated.  Use opticalflow_msgs-msg:acc_z instead.")
  (acc_z m))

(cl:ensure-generic-function 'stop-val :lambda-list '(m))
(cl:defmethod stop-val ((m <Traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opticalflow_msgs-msg:stop-val is deprecated.  Use opticalflow_msgs-msg:stop instead.")
  (stop m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <Traj>))
...
(cl:defmethod use_sensor-val ((m <Traj>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Traj>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'acc_z))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'stop))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Traj>) istream)
  "Deserializes a message object of type '<Traj>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'stop) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Traj>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 vx~%float64 vy~%float64 vz~%float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 stop~%int32 mode~%bool use_sensor~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Traj)))
  "Returns full string definition for message of type 'Traj"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 vx~%float64 vy~%float64 vz~%float64 acc_x~%float64 acc_y~%float64 acc_z~%float64 stop~%int32 mode~%bool use_sensor~%~%~%"))
